...
const CommonButton = ({ className, title, onClick, children }) => {
  return (
    ...
    text-sm  bg-greenPrimary
    tracking-[.66px] transition-all duration-500
    ${className ? className : ''}
    before:content-[''] before:absolute before:inset-0 before:bg-greenSecondary 
    ...
    hover:before:scale-100 hover:text-text-primary hover:bg-greenSecondary
  `}
    >
