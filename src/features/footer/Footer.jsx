  ...
  return (
    <FooterBox>
      <div className=" flex justify-between flex-col-reverse gap-10  lg:flex-row">
        <div className="flex flex-col  lg:flex-col xl:flex-row justify-between w-full mb-3 relative px-8 lg:mt-24 lg:mb-16 lg:ml-0 2xl:mt-32 2xl:ml-32 ">
          <div className="space-y-5 mb-0 lg:mb-5 xl:mb-0">
            ...
            <form onSubmit={handleSubmit} className="flex">
              <input
                name="email"
                className="bg-[#E6E4C6] placeholder:text-[#50704C] font-normal focus:outline-none pl-7 font-lato text-base w-full lg:text-2xl text-[#50704C]"
            ...
            <h4 className="footer-text-color hidden absolute bottom-0 lg:flex gap-1 tracking-tighter font-lato text-xl font-medium">
              ...
              <Link to="" className="border-b border-[#BBD6B8]">
                {t('footer.getInTouch')}
              </Link>
            </h4>
          </div>
          <div>
            <div className="flex flex-col mt-8 lg:mt-0 lg:flex-col xl:flex-row justify-between gap-5 xl:gap-32">
              <div className="flex flex-row lg:flex-row justify-between xl:flex-col lg:justify-between xl:justify-normal gap-8">
                <div className="flex flex-col gap-8">
                  {FOOTER_ELEMENT_L.map((elements) => (
                    <Link
                      to=""
                      className="underline footer-text-color text-lg font-medium font-lato border-[#BBD6B8]"
                    >
                      {t(elements.name)}
                    </Link>
                  ))}
              ...
              <div
                className="flex flow-row lg:flex-row xl:flex-col
        ...
        >
          <h4 className="text-[#195908] bg-[#F5F0E1] absolute bottom-10 left-10 w-40 px-5 py-2 rounded-full  text-2xl font-medium font-inter">
            @Roshoon
          </h4>
        </div>
      </div>
